...
//     constructor( {src, id, autoLoad = true,} ) {
...
//     set autoLoad(bool) { this.#autoLoad = bool }
...
//             console.log( 'no correct audio given' )
...
//     constructor( ...src ) {
//         if (!src) {
//             console.log('Alert: no src given to Muse constructor')
//         } else {
